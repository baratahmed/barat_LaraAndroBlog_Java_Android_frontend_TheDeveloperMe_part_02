...
public class ViewPagerAdapter extends PagerAdapter {
    ...
    private String descs[] = {
            "Learn sjkdhf jsdhf sjkdhf skjdhf ksjdhf ksdjfh ksjdf",
            "Create sdbfjhsgdf hjsgdf hsgdkjfhgs dkjfhsg dfkhsg",
            "Enjoy sdhfsjdhf kjsgdf kjsgdf sjhdgf sjhkdgfsdshd f"
    };
